...
try:
    ...
    from src.model_module import (
        ...
        run_standard_models,
        l1_logistic_regression_factory,
...
def run_walk_forward_models(ml_df):
    ...
    l1_logistic_predictions, l1_logistic_metrics = run_walk_forward_validation(
        df=ml_df,
        feature_columns=WALK_FORWARD_LOGISTIC_FEATURE_COLUMNS,
        model_factory=l1_logistic_regression_factory,
        model_name="L1 Logistic Regression",
    )
    print_walk_forward_summary(l1_logistic_metrics)
    results.append({
        "model_name": "L1 Logistic Regression",
        "evaluation_name": "walk_forward",
        "metrics": {"model_name": "L1 Logistic Regression", "evaluation_name": "walk_forward", **l1_logistic_metrics},
        "predictions": l1_logistic_predictions.assign(model_name="L1 Logistic Regression"),
    })
